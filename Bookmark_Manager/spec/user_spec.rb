...
describe User do
  ...
  describe '.authenticate' do
    ...
    it 'returns a user given the correct email and password' do
      user = User.create(email: 'testing@gmail.com', password: 'password123')
      authenticated_user = User.authenticate(email: 'testing@gmail.com', password: 'password123')
    ...
    it 'returns nil if the password is wrong' do
      ...
      expect(User.authenticate(email: 'testing@gmail.com', password: 'wrongpassword')).to be_nil
    end
  end
